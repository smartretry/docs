...
|---|---|---|
| Initialize recurring | `POST /v1/payments/recurring/init/{terminal_friendly_id}` | `400`, `403`, `404`, `409`, `500`, `503` |
...
| Charge recurring | `POST /v1/payments/recurring/charge/{terminal_friendly_id}` | `400`, `403`, `404`, `409`, `422`, `500`, `503` |
...
| Pre-authorization | `POST /v1/payments/preauth/{terminal_friendly_id}` | `400`, `403`, `404`, `409`, `422`, `500`, `503` |
| Sale | `POST /v1/payments/sale/{terminal_friendly_id}` | `400`, `403`, `404`, `409`, `422`, `500`, `503` |

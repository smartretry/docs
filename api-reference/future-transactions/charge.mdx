...
<ParamField body="merchant_transaction_id" type="string" required>
  Your unique identifier for this charge event. Used for idempotency — retrying with the same value returns the original result without triggering a second charge.
</ParamField>

...
response = requests.get(
    "https://api.smartretry.com/v1/payments/recurring/future-transactions/status/ABC123",
    headers={"x-api-key": "YOUR_API_KEY"},
    params={"future_transaction_id": "FT3D8E1C"}
)
...
const response = await fetch(
  "https://api.smartretry.com/v1/payments/recurring/future-transactions/status/ABC123?future_transaction_id=FT3D8E1C",
  {
    method: "GET",
    headers: {

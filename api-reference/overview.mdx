...
<CardGroup cols={3}>
  <Card title="Payments" icon="credit-card" href="/api-reference/payments/sale">
    Sale, pre-authorization, capture, their retry request variants, refunds, voids, and transaction
    status.
  </Card>
  <Card title="Recurring" icon="calendar-check" href="/api-reference/recurring/init">
    Initialize and charge recurring series, submit retry attempts through those same endpoints, and
    retrieve, update, or cancel a series.
  </Card>

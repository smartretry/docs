...
<ParamField body="amount" type="integer">
  Amount to capture in minor currency units. If omitted, the full authorized amount is captured. If provided, must be less than or equal to the authorized amount.
</ParamField>

...
response = requests.get(
    "https://api.smartretry.com/v1/payments/recurring/status/ABC123",
    headers={"x-api-key": "YOUR_API_KEY"},
    params={"recurring_id": "RC9F4A2B"}
)
...
const response = await fetch(
  "https://api.smartretry.com/v1/payments/recurring/status/ABC123?recurring_id=RC9F4A2B",
  {
    method: "GET",
    headers: {
